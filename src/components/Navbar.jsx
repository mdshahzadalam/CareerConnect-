        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-xl font-bold text-indigo-600">🎯 CareerConnect Pro</span>
            </div>
      ...
      {isOpen && (
        <div className="sm:hidden">
          <div className="pt-2 pb-3 space-y-1">
            ...
            <Link to="/jobs" className="border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
              Find Jobs
            </Link>
            ...
            <div className="pt-4 pb-3 border-t border-gray-200">
              <div className="mt-3 space-y-1">
                <button className="block w-full text-left px-4 py-2 text-base font-medium text-indigo-600 hover:text-indigo-800 hover:bg-indigo-50">
                  Post a Job
                </button>
              </div>
            </div>
